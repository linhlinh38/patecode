...
<main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
    <div className="text-center">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Unauthentication</h1>
        <p className="mt-6 text-base leading-7 text-gray-600">Sorry, you must be login before access this page.</p>
        <div className="mt-10 flex items-center justify-center gap-x-6">
            <a href="/home"
                ...
                back home</a>
            <a href="/login" className="text-sm font-semibold text-gray-900">Login <span
